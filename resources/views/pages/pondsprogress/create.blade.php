...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('pondsProgress.store')}}" method="post" enctype="multipart/form-data">
            @csrf
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control @error('number') border-danger @enderror" id="number" name="number" value="{{old('number')}}">
            </div>
          </div>
